...
type HandshakeMetadata struct {
	...
	UpdateInterval  uint32 `protobuf:"varint,2,opt,name=updateInterval,proto3" json:"updateInterval,omitempty"`
	TimeoutInterval uint32 `protobuf:"varint,3,opt,name=timeoutInterval,proto3" json:"timeoutInterval,omitempty"`
}
...
func (m *HandshakeMetadata) GetUpdateInterval() uint32 {
	if m != nil {
...
func (m *HandshakeMetadata) GetTimeoutInterval() uint32 {
	if m != nil {
...
var fileDescriptor_7d1794567e46a998 = []byte{
	...
	0x30, 0x6a, 0xf0, 0x06, 0xa1, 0x89, 0x0a, 0x69, 0x70, 0xf1, 0x97, 0x64, 0xe6, 0xa6, 0xe6, 0x97,
	...
	0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xa9, 0x81, 0xc5, 0x1b, 0xf7, 0x00, 0x00, 0x00,
}
